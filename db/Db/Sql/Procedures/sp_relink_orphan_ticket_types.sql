...
BEGIN
    FOR v_pair IN
        SELECT new_t."Id" AS new_id, old_t."Id" AS old_id
        ...
        WHERE new_t."EventId" = p_event_id
          AND new_t."IsActive" = true
    LOOP
        UPDATE purchases
           SET "EventTicketTypeId" = v_pair.new_id,
               "UpdatedAt" = now()
         WHERE "EventTicketTypeId" = v_pair.old_id;
