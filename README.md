...
└── svyneEventBackEnd.slnx   # Modern XML-based Visual Studio Solution file
```
...
- `DATABASE_URL`: PostgreSQL connection string (e.g. `Host=localhost;Database=svyne_dev;Username=postgres;Password=...`)
...
### 🔒 [AuthService](file:///d:/svyne-event-system/svyne-event-backend/docs/API_REFERENCE.md#L11-L17)

Handles user credential validation, JWT issuance, Google OAuth integration, session management, and magic-link delivery.

### 🏢 [TenantService](file:///d:/svyne-event-system/svyne-event-backend/docs/API_REFERENCE.md#L19-L29)
...
### 📅 [EventService](file:///d:/svyne-event-system/svyne-event-backend/docs/API_REFERENCE.md#L30-L33)

Manages event lifecycle (Draft, Published, Cancelled), scheduling, and timelines with strict conflict/overlap validation rules.

### 🎫 [Booking & TableBookingService](file:///d:/svyne-event-system/svyne-event-backend/docs/API_REFERENCE.md#L39-L50)
...
### 📊 [Reporting & AdminService](file:///d:/svyne-event-system/svyne-event-backend/docs/API_REFERENCE.md#L51-L89)
